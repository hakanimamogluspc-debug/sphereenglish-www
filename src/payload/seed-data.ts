...
export const SOLUTIONS = [
  {
    ...
    body: [
      ...
      'Araştırmalar, iş toplantılarında dil bariyerinin karar alma süreçlerini önemli ölçüde yavaşlattığını ortaya koymaktadır. Sphere English kursiyerleri, program sonunda toplantılara daha aktif katıldıklarını, fikirlerini net biçimde iletebildiklerini ve İngilizce ortamlarda öz güvenlerinin belirgin şekilde arttığını bildirmektedir. Oxford University Press müfredat kaynaklarıyla hazırlanan müfredat ve yapay zeka destekli konuşma analizi, gelişimi ölçülebilir ve hızlandırılabilir kılmaktadır.',
    ],
    highlights: [
