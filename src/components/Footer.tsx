  ...
  return (
    <footer style={{ background: '#0d1f4e' }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16">
        ...
        {/* Ödeme yöntemleri — Iyzico merchant onay kriterlerinden:
            "Visa ve MasterCard Logoları" + "Iyzico ile Öde Logosu" */}
        <div className="flex flex-col items-center gap-3 mb-8 pb-8 border-b border-white/10">
          <p className="text-[11px] font-semibold tracking-[0.18em] text-white/45 uppercase">Güvenli Ödeme</p>
          <img
            src="/assets/payment/logo_band_white.svg"
            alt="Iyzico, Visa, Mastercard, American Express, Troy — güvenli ödeme"
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-[12px] text-white/40">
            ...
            <Link href="/mesafeli-satis-sozlesmesi" className="hover:text-white/70 transition-colors">Mesafeli Satış</Link>
            <Link href="/teslimat-iade" className="hover:text-white/70 transition-colors">Teslimat & İade</Link>
