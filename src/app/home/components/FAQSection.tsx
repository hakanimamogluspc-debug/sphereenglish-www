...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: 'Evet, programlarımızın tamamı şirketinizin sektörüne, kullandığı terminolojiye ve çalışanların iş rollerine göre özelleştirilmektedir. Finans, teknoloji, sağlık, üretim, lojistik gibi pek çok sektörde sektör odaklı vaka çalışmaları ve gerçek iş senaryoları kullanıyoruz.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Web sitemizden randevu formumuzu doldurmanız yeterli. 24 saat içinde kurumsal danışmanımız sizi arayarak şirketinizin ihtiyaçlarını dinler ve ücretsiz demo dersi ile birlikte size özel bir teklif hazırlar. Herhangi bir taahhüt gerektirmiyor; deneyip karar verebilirsiniz.',
  },
];
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-10">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-[34px] lg:text-[46px] font-extrabold tracking-[-0.025em] text-[#1B365D] leading-[1.12] mb-4">
            Aklınızdaki soruları<br />
            <span className="text-[#0ea5e9]">yanıtlıyoruz.</span>
          </h2>
          <p className="text-[15px] text-gray-500 leading-relaxed max-w-md mx-auto">
            Kurumsal İngilizce eğitimi hakkında en çok merak edilen konuları derledik.
          </p>
        </div>
              ...
              >
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 13 13"
                    fill="none"
                    className={openIndex === i ? 'text-white' : 'text-[#1B365D]'}
                  >
